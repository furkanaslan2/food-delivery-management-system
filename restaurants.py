        ...
        if action in ['add', 'update']:
            ...
            if action == 'add':
                ...
                if restaurant_id:
                    ...
                    query = 'INSERT INTO restaurants (restaurant_id, user_id, restaurant_name, city, rating, rating_count, average_cost, table_count, cuisine, restaurant_address) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'
                    cursor.execute(query, (restaurant_id, user_id, restaurant_name, city, rating, rating_count, average_cost, table_count, cuisine, restaurant_address))
                else:
                    query = 'INSERT INTO restaurants (user_id, restaurant_name, city, rating, rating_count, average_cost, table_count, cuisine, restaurant_address) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)'
                    cursor.execute(query, (user_id, restaurant_name, city, rating, rating_count, average_cost, table_count, cuisine, restaurant_address))
                connection.commit()
                ...
                rating_count = request.form.get('rating_count')
                average_cost = request.form.get('average_cost')
                table_count = request.form.get('table_count') or None
                cuisine = request.form.get('cuisine')
                restaurant_address = request.form.get('restaurant_address')
                ...
                if not all([restaurant_name, city, rating_count, average_cost, cuisine, restaurant_address]):
                    flash("All fields (except Rating and Table Count) are required for update.", "warning")
                    return redirect(url_for('restaurants'))
                ...
                query = "UPDATE restaurants SET restaurant_id = %s, restaurant_name = %s, city = %s, rating = %s, rating_count = %s, average_cost = %s, table_count = %s, cuisine = %s, restaurant_address = %s WHERE restaurant_id = %s"
                cursor.execute(query, (new_restaurant_id, restaurant_name, city, rating, rating_count, average_cost, table_count, cuisine, restaurant_address, update_restaurant_id))
                connection.commit()
...
def restaurant_analytics():
    ...
    try:
        ...
        query_charts = """
            ...
            WHERE o.restaurant_id = %s AND o.order_status != 'canceled'
            GROUP BY f.food_id
