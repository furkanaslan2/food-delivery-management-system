document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateInputs(checkbox) {
        ...
        const tableCount = card.querySelector('.restaurant-table-count')?.textContent.trim() || '';
        ...
        document.getElementById('restaurant-table-count').value = tableCount;
    ...
    function clearInputs() {
        ...
        document.getElementById('restaurant-table-count').value = '';
    ...
    function handleCheckboxChange(event) {
        ...
        const selectedCheckboxes = document.querySelectorAll('#restaurant-list input[type="checkbox"]:checked');
